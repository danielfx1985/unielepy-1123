	...
	<view class="mask flex-center">
		<view class="content botton-radius">
			<view class="content-top">
				...
				<image class="content-top" style="top: 0;" width="100%" height="100%" src="../../static/unielepystatic/img/upgrade-app/bg_top.png">
				</image>
			</view>
			...
			<image v-if="!is_mandatory" class="close-img" src="../../static/unielepystatic/img/upgrade-app/app_update_close.png"
